...
/obj/item/clothing/head/soft/sol
	name = "\improper United Earth Government cap"
	desc = "It's a blue ballcap in UEG colors."
	icon_state = "solsoft"
...
/obj/item/clothing/head/soft/sol/fleet
	name = "fleet cap"
	desc = "It's a navy blue ballcap with the UNSC Fleet crest."
...
/obj/item/clothing/head/utility/fleet
	...
	desc = "A navy blue utility cover bearing the crest of the UNSC Fleet."
...
/obj/item/clothing/head/dress/expedition
	...
	desc = "A peaked grey dress uniform cap belonging to the UNSC Expeditionary Corps."
	icon_state = "greydresscap"

/obj/item/clothing/head/dress/expedition/command
	name = "expedition officer's dress cap"
	desc = "A peaked grey dress uniform cap belonging to the UNSC Expeditionary Corps. This one is trimmed in gold."
...
/obj/item/clothing/head/beret/sol
	...
	desc = "A beret in United Earth Government colors. For peacekeepers that are more inclined towards style than safety."
	icon_state = "beret_lightblue"

/obj/item/clothing/head/beret/sol/homeguard
	name = "home guard beret"
	desc = "A red beret denoting service in the UEG Home Guard. For personnel that are more inclined towards style than safety."
...
/obj/item/clothing/head/beret/sol/marcom
	...
	desc = "A red beret with a gold insignia, denoting service in the UNSC Mars Central Command. For brass who are more inclined towards style than safety."
	icon_state = "beret_redgold"

/obj/item/clothing/head/beret/sol/stratcom
	name = "\improper STRATCOM beret"
	desc = "A grey beret with a silver insignia, denoting service in the UNSC Strategic Command. For intelligence personnel who are more inclined towards style than safety."
	icon_state = "beret_graysilver"

/obj/item/clothing/head/beret/sol/diplomatic
	name = "diplomatic security beret"
	desc = "A tan beret denoting service in the UNSC Marine Corps Diplomatic Security Group. For security personnel who are more inclined towards style than safety."
...
/obj/item/clothing/head/beret/sol/expedition
	...
	desc = "A black beret belonging to the UNSC Expeditionary Corps. For personnel that are more inclined towards style than safety."
	icon_state = "beret_black"

/obj/item/clothing/head/beret/sol/expedition/security
	name = "expeditionary security beret"
	desc = "An UNSC Expeditionary Corps beret with a security crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_black_security"

/obj/item/clothing/head/beret/sol/expedition/medical
	name = "expeditionary medical beret"
	desc = "An UNSC Expeditionary Corps beret with a medical crest. For personnel that are more inclined towards style than safety."
...
/obj/item/clothing/head/beret/sol/expedition/engineering
	...
	desc = "An UNSC Expeditionary Corps beret with an engineering crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_black_engineering"

/obj/item/clothing/head/beret/sol/expedition/supply
	name = "expeditionary supply beret"
	desc = "An UNSC Expeditionary Corps beret with a supply crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_black_supply"

/obj/item/clothing/head/beret/sol/expedition/service
	name = "expeditionary service beret"
	desc = "An UNSC Expeditionary Corps beret with a service crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_black_service"

/obj/item/clothing/head/beret/sol/expedition/command
	name = "expeditionary officer's beret"
	desc = "An UNSC Expeditionary Corps beret with a golden crest. For personnel that are more inclined towards style than safety."
...
/obj/item/clothing/head/beret/sol/fleet/service
	...
	desc = "An UNSC Fleet beret with a service crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_service"

/obj/item/clothing/head/beret/sol/fleet/command
	name = "fleet officer's beret"
	desc = "An UNSC Fleet beret with a golden crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_command"

/obj/item/clothing/head/ushanka/fleet
	name = "fleet fur hat"
	desc = "An UNSC Fleet synthfur-lined hat for operating in cold environment."
	icon_state = "flushankadown"
	icon_state_up = "flushankaup"

/obj/item/clothing/head/ushanka/expedition
	name = "expeditionary fur hat"
	desc = "An UNSC Expeditionary Corps synthfur-lined hat for operating in cold environment."
	icon_state = "ecushankadown"
	icon_state_up = "ecushankaup"

/obj/item/clothing/head/ushanka/marine
	name = "marine fur hat"
	desc = "An UNSC Marine Corps synthfur-lined hat for operating in cold environment."
